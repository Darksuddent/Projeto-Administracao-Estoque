...
<body>
    <div class='tabela'>
        ...
        switch($tipo){
            case 1:
                echo "<tr><td>Nome<td>EAN<td>Estoque <td>Validade <td> Custo Unitário <td>NCM<td>CEST<td>Emissão<td>Preço de venda recomendado (MLB Padrão)<td>Concorrência<td> <a href='adicionar.php'><img src='bibliotecas/imagens/adicionar.png'></a>";
                break;
            case 2:
                echo "<tr><td>Nome<td>EAN<td>Estoque <td>Validade <td> Custo Unitário <td>NCM<td>CEST<td>Emissão<td>Preço de venda recomendado (Lojinha)<td>Concorrência<td> <a href='adicionar.php'><img src='bibliotecas/imagens/adicionar.png'></a>";
                break;
            case 3:
                echo "<tr><td>Nome<td>EAN<td>Estoque <td>Validade <td> Custo Unitário <td>NCM<td>CEST<td>Emissão<td>Preço de venda recomendado (Full)<td>Concorrência<td> <a href='adicionar.php'><img src='bibliotecas/imagens/adicionar.png'></a>";
                break;
            }
            ?>
        <?php
            ...
            if($result = $banco->query($query)){
                while($obj = $result->fetch_object()){
                    ...
                    if($_GET['id'] == $obj->id){
                        ...
                        <td style='background-color: rgba(195, 241, 149, 0.485); color: rgba(125, 219, 32, 1);'>".preverMargem($obj->custo, $margem, $tipo)." 
                        <td>$link
                        <td><a href='produtos.php?edit=1&id=$obj->id'><img src='bibliotecas/imagens/editar.png' class='supermini'></a><br><a href='confirmacao.php?id=$obj->id&c=$chave'><img src='bibliotecas/imagens/apagar.png' style='padding-top: 5px;'class='supermini' ></a>";
                        }else{
                            echo "<tr>
                        <td> $obj->nome 
                        <td> $obj->ean 
